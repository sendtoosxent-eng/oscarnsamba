...
export default function RootLayout({ children }: RootLayoutProps) {
  // Analytics is optional: if the env var isn't set (e.g. during local dev
  // or a deploy where GA hasn't been configured yet), we simply skip
  // rendering the GoogleAnalytics component instead of failing the build.
